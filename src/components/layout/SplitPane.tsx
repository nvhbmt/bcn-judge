  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`split-handle relative bg-slate-200 outline-offset-0 transition-colors hover:bg-primary/50 focus-visible:bg-primary/60 focus-visible:outline-2 focus-visible:outline-primary dark:bg-slate-700 ${
