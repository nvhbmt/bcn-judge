...
Python: a, b = map(int, input().split());  print(a + b)`}
      ...
      <section>
        ...
        <ul className="list-disc space-y-1 pl-5 text-ink-3">
          ...
          <li>
            <kbd>Ctrl</kbd>/<kbd>⌘</kbd> + <kbd>Shift</kbd> + <kbd>Enter</kbd> — nộp bài
          </li>
          <li>
            <kbd>Tab</kbd> / <kbd>Shift</kbd>+<kbd>Tab</kbd> — thụt lề; nhấn <kbd>Esc</kbd> trước rồi <kbd>Tab</kbd> để
            rời khỏi ô soạn code
          </li>
        </ul>
      </section>
      ...
      {role !== 'member' ? (
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5 text-ink-3">
            ...
            <li>
              Luôn bấm <b>Kiểm tra bằng lời giải mẫu</b> trước khi xuất bản — hệ thống báo đúng testcase nào lệch.
            </li>
            <li>
              Đề của contest chưa mở không được đặt nội dung quyết định chỉ trong ảnh: ảnh phục vụ theo id nên không
              chặn theo khung giờ được.
            </li>
          </ul>
        </section>
      ) : null}
