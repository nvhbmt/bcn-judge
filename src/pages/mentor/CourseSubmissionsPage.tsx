    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="min-h-0 flex-1">
        <SplitPane
          ...
          left={
            <div className="flex h-full min-h-0 flex-col">
              <p className="shrink-0 border-b border-line px-3.5 py-2.5 font-mono text-[11px] tracking-[0.14em] text-ink-6 uppercase">
              ...
              {!hocVien || hocVien.length === 0 ? (
                ...
                <>
                  ...
                  <p className="shrink-0 border-y border-line px-3.5 py-2.5 font-mono text-[11px] tracking-[0.14em] text-ink-6 uppercase">
